...
PROCEDURAL_STOPWORDS = {
    "minister", "ministers", "deputy", "deputies", "secretary", "secretaries",
    "department", "departments",  "office", "offices",
    "question", "questions", "answer", "answers", "asked", "asking", "respond", "responded", "responding", "reply", "replied", "replying",
    "information"
}